#!/usr/bin/env python3
"""Source-specialized Taichi EKF control.

This is still an ordinary Taichi program.  It gives the Taichi kernel the
same source-level opportunities as the native Mech control: scalar component
fields (SoA), fixed 3x3 arithmetic, in-place unchecked state, and an explicit
Metal block size.  It does not reach into Taichi internals or bypass its
per-turn synchronization boundary.
"""
