...
def main() raises:
    ...
    _ = dispatch(state0, state1, state2, p00, p01, p02, p10, p11, p12, p20, p21, p22, velocity, angular_velocity, bearing, 5, False)
    ...
    print("synchronization: once after fused block")
