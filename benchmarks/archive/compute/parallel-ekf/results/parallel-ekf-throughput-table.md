...
| 19 | Futhark multicore, 8 workers (10k x 20) | Futhark | 48.391 |
| 20 | Mech GPU, checked repeated | Mech | 56.279 |
| 21 | Mech Cranelift SIMD-JIT parallel | Mech | 57.950 |
| 22 | Mech GPU, checked one-turn | Mech | 62.798 |
| 23 | NumPy/Numba parallel JIT, 8 workers | NumPy | 77.225 |
| 24 | NumPy/Numba, fused worker-local block checked (8 workers) | NumPy | 80.323 |
| 25 | Taichi LLVM CPU, 8 workers | Taichi | 86.047 |
| 26 | Mech SIMD/JIT CPU, 8 workers | Mech | 104.783 |
| 27 | Julia SIMD.jl, 8 workers | Julia | 106.341 |
| 28 | Futhark ISPC fixed-mode, 8 workers (500k x 40) | Futhark | 108.718 |
...
| 25 | Mech Cranelift SIMD-JIT parallel unchecked fast | Mech | 61.823 |
| 26 | NumPy/Numba parallel JIT, 8 workers | NumPy | 77.130 |
| 27 | NumPy/Numba, fused worker-local block (8 workers) | NumPy | 81.972 |
| 28 | NumPy/Numba, fused worker-local block fast math (8 workers) | NumPy | 86.973 |
| 29 | Taichi LLVM CPU, 8 workers | Taichi | 98.140 |
| 30 | Julia SIMD.jl, 8 workers | Julia | 109.628 |
| 31 | Mech SIMD/JIT CPU, 8 workers | Mech | 110.469 |
| 32 | Julia SIMD.jl, fused worker-local block (8 workers) | Julia | 133.605 |
| 33 | Mech SIMD/JIT CPU, persistent pool per-turn (8 workers) | Mech | 150.395 |
| 34 | Futhark ISPC fixed-mode, 8 workers (500k x 40) | Futhark | 152.330 |
| 35 | Mech GPU, WGPU per-turn | Mech | 157.141 |
| 36 | Rust packed SIMD, fused worker-local block (8 workers) | Rust | 163.866 |
| 37 | Mech SIMD/JIT CPU, fused unchecked block (8 workers) | Mech | 165.830 |
| 38 | Taichi GPU, native Metal | Taichi | 194.793 |
| 39 | Julia GPU, native Metal (strict retained-state) | Julia | 199.454 |
| 40 | Halide GPU, native Metal (strict fault-observing) | Halide | 212.283 |
| 41 | Taichi optimized native Metal, unchecked | Taichi | 217.297 |
| 42 | Mech GPU, native Metal | Mech | 275.534 |
| 43 | Mech GPU, unchecked repeated | Mech | 350.930 |
| 44 | Mech GPU, unchecked in-place repeated | Mech | 433.892 |
| 45 | Mech GPU, unchecked one-submit | Mech | 3729.673 |
