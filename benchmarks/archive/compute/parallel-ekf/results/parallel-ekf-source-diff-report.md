...
| Futhark | same data-parallel program | same program; multicore worker count | 10,000 x 20 -> 10,000 x 20 | 45 / 2,307 | 45 / 2,307 | 0 / 0 | 46 / 2,430 | 46 / 2,430 | 19.614 | 19.635 | 48.391 | 47.824 |
...
- **Rust**: The compact controls preserve the checked-in Rust algorithms while removing narrative scaffolding; the advanced control still changes the value representation and execution loop. Baseline -> advanced touches **493 lines / 15950 characters**.
