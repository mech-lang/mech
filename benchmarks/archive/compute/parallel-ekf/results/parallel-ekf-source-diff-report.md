...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Mech | compact high-level `.mec` program | same compact `.mec`; native backend selected at build | 10,000 x 20 -> 500,000 x 40 | 42 / 1,513 | 42 / 1,513 | 0 / 0 | 0 / 0 | 0 / 0 | 0.919 | 1.029 | 187.999 | 275.534 |
...
| Halide | same fixed-shape JIT pipeline | same pipeline; strict checked publication and fault output | 500,000 x 40 -> 500,000 x 40 | 324 / 8,928 | 324 / 8,928 | 0 / 0 | 349 / 12,174 | 349 / 12,174 | 111.474 | 212.283 | 111.474 | 212.283 |
