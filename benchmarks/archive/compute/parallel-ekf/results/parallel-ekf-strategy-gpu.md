...
Synchronized GPU controls, one dispatch per turn. Workload: **500,000 filters x 40 turns, synchronized per turn**. Checked and unchecked are separate columns; source edits are measured against each language's baseline source.
