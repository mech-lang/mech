...
#[cfg(feature = "source")]
fn impl_range_increment_exclusive_fxn(
    ...
    fn specialize(&self, arguments: &[LegacyValue]) -> MResult<Box<dyn MechFunction>> {
        ...
        match impl_range_increment_exclusive_fxn(arg1.clone(), arg2.clone(), arg3.clone()) {
            ...
            Err(_) => match (arg1, arg2, arg3) {
                ...
                ) => impl_range_increment_exclusive_fxn(
                    arg1.borrow().clone(),
                    arg2.borrow().clone(),
                    arg3.borrow().clone(),
                ),
                ...
                (LegacyValue::MutableReference(arg1), arg2, arg3) => impl_range_increment_exclusive_fxn(
                    arg1.borrow().clone(),
                    arg2.clone(),
                    arg3.clone(),
                ),
                ...
                (arg1, LegacyValue::MutableReference(arg2), arg3) => impl_range_increment_exclusive_fxn(
                    arg1.clone(),
                    arg2.borrow().clone(),
                    arg3.clone(),
                ),
                (arg1, arg2, LegacyValue::MutableReference(arg3)) => impl_range_increment_exclusive_fxn(
                    arg1.clone(),
                    arg2.clone(),
                    arg3.borrow().clone(),
                ),
                (arg1, arg2, arg3) => Err(MechError::new(
                    UnhandledFunctionArgumentKind3 {
                        ...
                        fxn_name: "range/exclusive-increment".to_string(),
                    },
                    None,
                )
                .with_compiler_loc()),
