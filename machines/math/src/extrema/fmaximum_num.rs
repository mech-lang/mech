...
macro_rules! fmaximum_num_op {
  ($arg1:expr, $arg2:expr, $out:expr) => {
    unsafe{(*$out) = fmaximum_num((*$arg1),(*$arg2));}
  };}
  ...
  ($arg1:expr, $arg2:expr, $out:expr) => {
    unsafe {
      ...
      for i in 0..arg1_deref.len() {
        (out_deref[i]) = fmaximum_num(arg1_deref[i],arg2_deref[i]);
      }}};}

macro_rules! fmaximum_numf_op {
  ($arg1:expr, $arg2:expr, $out:expr) => {
    unsafe{(*$out) = fmaximum_numf((*$arg1),(*$arg2));}
  };}
...
macro_rules! fmaximum_numf_vec_op {
  ($arg1:expr, $arg2:expr, $out:expr) => {
    unsafe {
      ...
      let mut out_deref = (&mut *$out);
      for i in 0..arg1_deref.len() {
        (out_deref[i]) = fmaximum_numf(arg1_deref[i],arg2_deref[i]);
      }}};}
...
fn impl_fmaximum_num_fxn(arg1_value: Value, arg2_value: Value) -> MResult<Box<dyn MechFunction>> {
  match (arg1_value,arg2_value) {
    ...
    (arg1,arg2) => Err(MechError2::new(
        UnhandledFunctionArgumentKind2 { arg: (arg1.kind(),arg2.kind()), fxn_name: "math/fmaximum-num".to_string() },
        None
      ).with_compiler_loc()
    ),
  }
