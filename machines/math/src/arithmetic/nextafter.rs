...
#[cfg(feature = "source")]
fn impl_nextafter_fxn(arg1_value: LegacyValue, arg2_value: LegacyValue) -> MResult<Box<dyn MechFunction>> {
    match (arg1_value, arg2_value) {
        #[cfg(feature = "f32")]
        (LegacyValue::F32(arg1), LegacyValue::F32(arg2)) => Ok(Box::new(NextafterF32 {
            arg1,
            arg2,
        ...
        #[cfg(feature = "f64")]
        (LegacyValue::F64(arg1), LegacyValue::F64(arg2)) => Ok(Box::new(NextafterF64 {
            arg1,
            arg2,
        ...
        (arg1, arg2) => Err(MechError::new(
            UnhandledFunctionArgumentKind2 {
                ...
                fxn_name: "math/nextafter".to_string(),
            },
            None,
        )
        .with_compiler_loc()),
...
#[cfg(feature = "source")]
impl FunctionSpecializer for MathNextafter {
        ...
        match impl_nextafter_fxn(arg1.clone(), arg2.clone()) {
            ...
            Err(_) => match (arg1, arg2) {
                (LegacyValue::MutableReference(arg1), LegacyValue::MutableReference(arg2)) => {
                    impl_nextafter_fxn(arg1.borrow().clone(), arg2.borrow().clone())
                }
                (LegacyValue::MutableReference(arg1), arg2) => {
                    impl_nextafter_fxn(arg1.borrow().clone(), arg2.clone())
                }
                (arg1, LegacyValue::MutableReference(arg2)) => {
                    impl_nextafter_fxn(arg1.clone(), arg2.borrow().clone())
                }
                (arg1, arg2) => Err(MechError::new(
                    UnhandledFunctionArgumentKind2 {
                        arg: (arg1.kind(), arg2.kind()),
