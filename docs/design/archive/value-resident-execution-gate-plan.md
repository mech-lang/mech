# Archived value-resident execution gate plan

This document preserves the historical Gate A/B execution and benchmark plan.
It is not a live architecture gate. Current behavior is owned by the runtime
cost benchmarks, resident EKF tests and benchmarks, and direct publication and
recording contracts.
