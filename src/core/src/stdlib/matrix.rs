...
//impl_access_fxn_shape!(Access2DRDRVb, (RowDVector<usize>,DVector<bool>), DMatrix<T>, access_2d_slice_bool2);
...
//impl_access_fxn_shape!(Access2DVDRRb, (DVector<usize>,RowDVector<bool>), DMatrix<T>, access_2d_slice_bool2);
