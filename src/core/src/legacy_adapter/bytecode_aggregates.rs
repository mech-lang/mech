// Legacy composite bytecode reconstruction remains quarantined here until the
// compatibility adapter is deleted. Canonical callers use the re-exports in
// `program::bytecode::aggregates`.
#[cfg(any(
    feature = "tuple",
    feature = "record",
    feature = "map",
...
use crate::{
    AsValueKind, BytecodeValidationError, DimensionExpr, FloatWidth, IntegerWidth, KindExpr,
    KindId, LegacyValue, MResult, MechError, SchemaBody, Value, ValueCell, ValueData,
    ValueDataDraft, ValueKind,
};
