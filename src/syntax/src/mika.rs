...
pub fn mika_expression_inner(input: ParseString) -> ParseResult<MikaExpression> {
  ...
  let expr = match (l.as_str(), nose_face, r.as_str()) {
    ("ˆ",   MikaNose::Open,      "ˆ")   => MikaExpression::Content,
    ("ಠ",   MikaNose::Open,      "ಠ")   => MikaExpression::Confused,
    ("╥",   MikaNose::Open,      "╥")   => MikaExpression::Crying,
    ("⋇",   MikaNose::Open,      "⋇")   => MikaExpression::Dazed,
    ("✖",   MikaNose::Open,      "✖")   => MikaExpression::Dead,
    ("≻",   MikaNose::Open,      "≺")   => MikaExpression::EyesSqueezed,
    ("ᗒ",   MikaNose::Open,      "ᗕ")   => MikaExpression::SuperSqueezed,
    ("ㆆ",  MikaNose::FlatMouth, "ㆆ")  => MikaExpression::Glaring,
    ("◜",   MikaNose::Open,      "◝")   => MikaExpression::Happy,
    ("˙",   MikaNose::Open,      "˙")   => MikaExpression::Normal,
    ("⚆",   MikaNose::Open,      "⚆")   => MikaExpression::PeerRight,
    ("☉",   MikaNose::Open,      "☉")   => MikaExpression::PeerStraight,
    ("◠",   MikaNose::Open,      "◠")   => MikaExpression::Pleased,
    ("◡̀",  MikaNose::Open,      "◡́")  => MikaExpression::Resolved,
    ("◕",   MikaNose::Open,      "◕")   => MikaExpression::RollingEyes,
    ("◞",   MikaNose::Open,      "◟")   => MikaExpression::Sad,
    ("Ͼ",   MikaNose::Open,      "Ͽ")   => MikaExpression::Scared,
    ("⌐▰",  MikaNose::Open,      "▰")   => MikaExpression::Shades,
    ("⹇",   MikaNose::Open,      "⹇")   => MikaExpression::Sleeping,
    ("ᗣ",   MikaNose::Open,      "ᗣ")   => MikaExpression::Smiling,
    ("≖",   MikaNose::Open,      "≖")   => MikaExpression::Squinting,
    ("°",   MikaNose::Open,      "°")   => MikaExpression::Surprised,
    ("ᗩ",   MikaNose::Open,      "ᗩ")   => MikaExpression::TearingUp,
    ("¬",   MikaNose::Open,      "¬")   => MikaExpression::Unimpressed,
    ("◉",   MikaNose::Open,      "◉")   => MikaExpression::Wired,
    _ => {
