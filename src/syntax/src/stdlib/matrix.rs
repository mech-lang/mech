  ...
  ($fxn_name:ident, $ix:tt, $ixes:expr, $arg:expr, $($input_type:ident => $($matrix_kind:ident, $target_type:ident, $default:expr),+);+ $(;)?) => {
    paste!{
      match $arg {
        $(
          $(
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector4(input)), $ix) => Ok(Box::new([<$fxn_name R4>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector3(input)), $ix) => Ok(Box::new([<$fxn_name R3>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector2(input)), $ix) => Ok(Box::new([<$fxn_name R2>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Vector4(input)),    $ix) => Ok(Box::new([<$fxn_name V4>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Vector3(input)),    $ix) => Ok(Box::new([<$fxn_name V3>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Vector2(input)),    $ix) => Ok(Box::new([<$fxn_name V2>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix2(input)),    $ix) => Ok(Box::new([<$fxn_name M2>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix3(input)),    $ix) => Ok(Box::new([<$fxn_name M3>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix4(input)),    $ix) => Ok(Box::new([<$fxn_name M4>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix2x3(input)),  $ix) => Ok(Box::new([<$fxn_name M2x3>]{source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix3x2(input)),  $ix) => Ok(Box::new([<$fxn_name M3x2>]{source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::DMatrix(input)),    $ix) => Ok(Box::new([<$fxn_name MD>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::RowDVector(input)), $ix) => Ok(Box::new([<$fxn_name RD>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::DVector(input)),    $ix) => Ok(Box::new([<$fxn_name VD>]  {source: input.clone(), ixes: $ixes, out: new_ref($default) })),
          )+
        )+
...
fn generate_access_scalar_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_scalar_match_arms!(
    Access1DS,
...
macro_rules! generate_access_scalar_scalar_match_arms {
  ($fxn_name:ident, $ix:tt, $ixes:tt, $arg:expr, $($input_type:ident => $($matrix_kind:ident, $target_type:ident, $default:expr),+);+ $(;)?) => {
    paste!{
      match $arg {
        $(
          $(
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector4(input)), $ix) => Ok(Box::new([<$fxn_name R4>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector3(input)), $ix) => Ok(Box::new([<$fxn_name R3>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector2(input)), $ix) => Ok(Box::new([<$fxn_name R2>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Vector4(input)),    $ix) => Ok(Box::new([<$fxn_name V4>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Vector3(input)),    $ix) => Ok(Box::new([<$fxn_name V3>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Vector2(input)),    $ix) => Ok(Box::new([<$fxn_name V2>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix2(input)),    $ix) => Ok(Box::new([<$fxn_name M2>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix3(input)),    $ix) => Ok(Box::new([<$fxn_name M3>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix4(input)),    $ix) => Ok(Box::new([<$fxn_name M4>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix2x3(input)),  $ix) => Ok(Box::new([<$fxn_name M2x3>]{source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix3x2(input)),  $ix) => Ok(Box::new([<$fxn_name M3x2>]{source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::DMatrix(input)),    $ix) => Ok(Box::new([<$fxn_name MD>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::RowDVector(input)), $ix) => Ok(Box::new([<$fxn_name RD>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
            (Value::$matrix_kind(Matrix::<$target_type>::DVector(input)),    $ix) => Ok(Box::new([<$fxn_name VD>]  {source: input.clone(), ixes: new_ref($ixes), out: new_ref($default) })),
          )+
        )+
...
fn generate_access_scalar_scalar_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_scalar_scalar_match_arms!(
    Access2DSS,
    [Value::Index(ix1),Value::Index(ix2)],(ix1.borrow().clone(),ix2.borrow().clone()),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
  ...
  ($fxn_name:ident, $ix:tt, $ixes:expr, $arg:expr, $($input_type:ident => $($matrix_kind:ident, $target_type:ident, $default:expr),+);+ $(;)?) => {
    paste!{
      match $arg {
        $(
          $(
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector3(input)), [Value::MatrixBool(Matrix::RowVector2(ix))])  => Ok(Box::new(Access1DR2bR3{source: input.clone(), ixes: ix.clone(), out: new_ref(RowDVector::from_element(input.borrow().len(),$default)) })),    
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector3(input)), [Value::MatrixBool(Matrix::RowVector3(ix))])  => Ok(Box::new(Access1DR3bR3{source: input.clone(), ixes: ix.clone(), out: new_ref(RowDVector::from_element(input.borrow().len(),$default)) })),    
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector3(input)), [Value::MatrixBool(Matrix::RowVector4(ix))])  => Ok(Box::new(Access1DR4bR3{source: input.clone(), ixes: ix.clone(), out: new_ref(RowDVector::from_element(input.borrow().len(),$default)) })),    
            (Value::$matrix_kind(Matrix::<$target_type>::RowVector3(input)), [Value::MatrixBool(Matrix::RowDVector(ix))])  => Ok(Box::new(Access1DRDbR3{source: input.clone(), ixes: ix.clone(), out: new_ref(RowDVector::from_element(input.borrow().len(),$default)) })),    
...
fn generate_access_range_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_range_match_arms!(
    Access1DR,
    [Value::MatrixBool(Matrix::RowVector3(ix))],ix.clone(),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
...
fn generate_access_range_range_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_range_range_match_arms!(
    Access2DRR,
    [Value::MatrixIndex(Matrix::RowVector2(ix1)), Value::MatrixIndex(Matrix::RowVector2(ix2))],(ix1.borrow().clone(),ix2.borrow().clone()),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
  ...
  ($fxn_name:ident, $ix:tt, $ixes:expr, $arg:expr, $($input_type:ident => $($matrix_kind:ident, $target_type:ident, $default:expr),+);+ $(;)?) => {
    paste!{
      match $arg {
        $(
          $(
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix3x2(input)), [Value::IndexAll]) => Ok(Box::new(Access1DAM3x2{source: input.clone(), ixes: new_ref(Value::IndexAll), out: new_ref(DVector::from_element(6,$default)) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix3(input)),   [Value::IndexAll]) => Ok(Box::new(Access1DAM3  {source: input.clone(), ixes: new_ref(Value::IndexAll), out: new_ref(DVector::from_element(9,$default)) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix2(input)),   [Value::IndexAll]) => Ok(Box::new(Access1DAM2  {source: input.clone(), ixes: new_ref(Value::IndexAll), out: new_ref(DVector::from_element(4,$default)) })),
...
fn generate_access_all_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_all_match_arms!(
    Access1DA,
  ...
  ($fxn_name:ident, $ix:tt, $ixes:expr, $arg:expr, $($input_type:ident => $($matrix_kind:ident, $target_type:ident, $default:expr),+);+ $(;)?) => {
    paste!{
      match $arg {
        $(
          $(
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix2(input)), [Value::IndexAll,Value::Index(ix)]) => Ok(Box::new(Access2DASM2{source: input.clone(), ixes: ix.clone(), out: new_ref(DVector::from_element(2,$default)) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix3(input)), [Value::IndexAll,Value::Index(ix)]) => Ok(Box::new(Access2DASM3{source: input.clone(), ixes: ix.clone(), out: new_ref(DVector::from_element(3,$default)) })),
...
fn generate_access_all_scalar_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_all_scalar_match_arms!(
    Access2DSA,
    [Value::IndexAll,Value::Index(ix)],ix.clone(),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
  ...
  ($fxn_name:ident, $ix:tt, $ixes:expr, $arg:expr, $($input_type:ident => $($matrix_kind:ident, $target_type:ident, $default:expr),+);+ $(;)?) => {
    paste!{
      match $arg {
        $(
          $(
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix2(input)), [Value::Index(ix),Value::IndexAll]) => Ok(Box::new(Access2DSAM2{source: input.clone(), ixes: ix.clone(), out: new_ref(RowDVector::from_element(2,$default)) })),
            (Value::$matrix_kind(Matrix::<$target_type>::Matrix3(input)), [Value::Index(ix),Value::IndexAll]) => Ok(Box::new(Access2DSAM3{source: input.clone(), ixes: ix.clone(), out: new_ref(RowDVector::from_element(3,$default)) })),
            (Value::$matrix_kind(Matrix::<$target_type>::DMatrix(input)), [Value::Index(ix),Value::IndexAll]) => Ok(Box::new(Access2DSAMD{source: input.clone(), ixes: ix.clone(), out: new_ref(RowDVector::from_element(input.borrow().ncols(),$default)) })),
          )+
        )+
        x => Err(MechError { tokens: vec![], msg: format!("{:?}",x), id: line!(), kind: MechErrorKind::UnhandledFunctionArgumentKind }),
      }
...
fn generate_access_scalar_all_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_scalar_all_match_arms!(
    Access2DSA,
    [Value::Index(ix),Value::IndexAll],ix.clone(),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
...
fn generate_access_all_range_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_all_range_match_arms!(
    Access2DAR,
    [Value::IndexAll, Value::MatrixIndex(Matrix::RowVector2(ix))],ix.clone(),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
...
fn generate_access_range_all_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_range_all_match_arms!(
    Access2DRA,
    [Value::MatrixIndex(Matrix::RowVector2(ix)), Value::IndexAll],ix.clone(),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
...
fn generate_access_range_scalar_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_range_scalar_match_arms!(
    Access2DRS,
    [Value::MatrixIndex(Matrix::RowVector2(ix1)), Value::Index(ix2)],(ix1.borrow().clone(),ix2.borrow().clone()),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
...
fn generate_access_scalar_range_fxn(lhs_value: Value, ixes: Vec<Value>) -> Result<Box<dyn MechFunction>, MechError> {
  generate_access_scalar_range_match_arms!(
    Access2DSR,
    [Value::Index(ix1),Value::MatrixIndex(Matrix::RowVector2(ix2))],(ix1.borrow().clone(),ix2.borrow().clone()),
    (lhs_value, ixes.as_slice()),
    Bool => MatrixBool, bool, false;
    I8   => MatrixI8,   i8,   i8::zero();
    I16  => MatrixI16,  i16,  i16::zero();
