...
impl FragmentKind {
    ...
    pub const fn mode(self) -> ParseMode {
        match self {
            ...
            Self::MechItem | Self::VariableDefine | Self::Expression | Self::ParentheticalTerm => {
                ParseMode::Mech
            }
...
fn context_matches(parser: &Parser<'_>, kind: FragmentKind, context: ParseContext) -> bool {
