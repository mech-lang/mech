...
pub(crate) fn compile_browser_document_bundle(
    ...
    let product = if regions.is_empty() {
        ...
        #[cfg(feature = "compute_backends_native")]
        {
            ...
            mech_engine::ProgramCompilationProduct::from_canonical_artifact(
                mixed.coordinator.into_artifact(),
            )?
            .with_source_dependencies(mixed.source_dependencies)
        }
