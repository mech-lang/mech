...
pub(crate) fn prepare(
    ...
    config_args: config::ConfigCliArgs,
    capability_args: capabilities::FilesystemCapabilityArgs,
    _host_delegation_args: serve_options::ServeHostDelegationArgs,
    resources: WebResourceDefaults,
) -> MResult<ServePlan> {
    let loaded = config::load_cli_config_report_from_args(&config_args, &args.paths)?;
...
fn serve_host_delegation_injection(
    args: &serve_options::ServeHostDelegationArgs,
