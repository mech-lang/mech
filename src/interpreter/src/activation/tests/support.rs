    pub(super) use super::super::{
        ...
        ActivationPatternWildcardMustBeLast, ActivationScopeTriggerWriteUnsupported, Finalize,
        Gate, GuardFinalize, Matcher, ReactiveBindingSink, Select, UnmatchedFinalize,
    ...
    pub(super) use crate::{
        ...
        PatternMatch, R64, ReactiveCellId, ReactiveDependencyKind, ReactiveNodeId,
        ReactiveNodeKind, ReactiveRegisterCommit, ReactiveTurnOutcome, Ref, Register,
        SymbolTableSnapshot, ValRef, Value, ValueKind, hash_str,
    };
    ...
    pub(super) fn committed_capture_value(interpreter: &Interpreter, arm: usize, capture: usize) -> Value {
    ...
    pub(super) fn proposed_capture_value(interpreter: &Interpreter, arm: usize, capture: usize) -> Value {
        let registration = registration(interpreter);
        let arm = &registration.arms[arm];
        arm.captures
            .get(capture)
