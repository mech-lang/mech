...
#[cfg(feature = "enum")]
use crate::{
  EnumDefine, InterpreterExecution, MResult, MechEnum, Ref, kind_annotation,
};
...
#[cfg(all(feature = "enum", feature = "atom"))]
pub(super) fn value_matches_enum_variant(value: &Value, enum_id: u64, state: &ProgramState) -> bool {
