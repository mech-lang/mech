...
impl LosslessInto<R64> for f64 {
    fn lossless_into(self) -> R64 {
        R64::from_f64(self)
            .unwrap_or_else(|| panic!("Cannot convert F64 to R64: value is not representable"))
    }
}
...
impl LosslessInto<R64> for f32 {
    fn lossless_into(self) -> R64 {
        R64::from_f64(self as f64)
            .unwrap_or_else(|| panic!("Cannot convert F32 to R64: value is not representable"))
    }
}
...
impl LossyFrom<R64> for f64 {
    fn lossy_from(value: R64) -> Self {
        value
            .to_f64()
            .unwrap_or_else(|| panic!("Cannot convert R64 to F64: value is not representable"))
    }
}
