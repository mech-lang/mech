...
impl ResidentReplRuntimeFactory for WasmReplRuntimeFactory {
    ...
    fn activate_document(
        ...
        match self {
            ...
            Self::Document(bootstrap) => crate::project::activate_document_repl_runtime_document(
                bootstrap,
                events,
                document.clone(),
            ),
...
impl WasmRepl {
    ...
    pub(crate) fn from_document(bootstrap: crate::project::WasmDocumentBootstrap) -> MResult<Self> {
        ...
        let initial_document = bootstrap.initial_repl_document();
        Ok(Self {
            session: ResidentReplSession::from_document(
