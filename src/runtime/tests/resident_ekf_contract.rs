...
use mech_engine::__resident_ekf::{
    PreparedResidentTurn, ResidentEkfBatch, ResidentExecutionError as ResidentEkfExecutionError,
...
fn high_epoch_executes_the_same_trajectory_and_work() {
    ...
    high.set_next_epoch_for_benchmark(1_000_000_001);
...
fn rejection_failure_kinds_and_phases_are_stable_and_bounded() {
    let failures = [
        (
            ResidentEkfExecutionError::EpochExhausted,
            TurnFailurePhase::Execution,
            "ResidentEpochExhausted",
        ),
        (
            ResidentEkfExecutionError::IncompleteCandidate,
            TurnFailurePhase::Integrity,
            "ResidentIncompleteCandidate",
        ),
        (
            ResidentEkfExecutionError::LandmarkDistance,
            TurnFailurePhase::Integrity,
            "ResidentLandmarkDistance",
        ),
        (
            ResidentEkfExecutionError::InnovationDeterminant,
            TurnFailurePhase::Integrity,
            "ResidentInnovationDeterminant",
        ),
        (
            ResidentEkfExecutionError::NonFiniteState,
            TurnFailurePhase::Integrity,
            "ResidentNonFiniteState",
        ),
        (
            ResidentEkfExecutionError::CovarianceDiagonal,
            TurnFailurePhase::Integrity,
            "ResidentCovarianceDiagonal",
        ),
        (
            ResidentEkfExecutionError::CovarianceSymmetry,
            TurnFailurePhase::Integrity,
