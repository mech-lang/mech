...
impl RuntimeWorkspaceConfig {
    ...
    pub fn target(mut self, name: impl Into<String>, specifier: impl Into<String>) -> Self {
    ...
    pub fn folder(mut self, specifier: impl Into<String>) -> Self {
    ...
    pub fn folder_recursive(mut self, specifier: impl Into<String>, recursive: bool) -> Self {
        self.folders.push(RuntimeWorkspaceFolder {
            specifier: specifier.into(),
            recursive,
        });
