...
use mech_core::{MResult, MechError, TransactionStateUnsupportedError};
...
impl CapabilityRequest {
    pub fn new(subject: &dyn Subject, operation: &dyn Operation, resource: &dyn Resource) -> Self {
        Self {
...
pub trait Capability: std::fmt::Debug + Send + Sync {
    ...
    fn preview_check(&self, _request: &CapabilityRequest) -> MResult<CapabilityDecision> {
        Err(MechError::new(
