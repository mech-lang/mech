...
impl FullWriteEpochFixture {
    pub fn new() -> Self {
        ...
        .expect("resident EKF full-write ledger");
    ...
    fn run_turn(&mut self, turn: usize, input: f64, reject: bool) -> Result<(), &'static str> {
        ...
        let identity = u64::try_from(turn + 1).expect("resident EKF full-write identity");
        ...
        let prepared = prepare_retained(&mut self.ledger, permit, receipt)
            .expect("resident EKF full-write receipt preparation");
