...
expected_surface = {
    ...
    "full-runtime": (9022, 0, 0, 0, 0, expected_digest, "sha256-raw-frozen-runtime-surface-json"),
    "full-source": (9022, 119, 10, 52, 50, expected_digest, "sha256-raw-frozen-runtime-surface-json"),
    "full-compiler": (9022, 119, 10, 52, 50, expected_digest, "sha256-raw-frozen-runtime-surface-json"),
}
surface_keys = (
